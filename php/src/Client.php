...
namespace APIVerve\Hangmanword;
...
/**
 * Client for the Hangman Word Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/hangmanword?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/hangmanword';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HangmanwordClient] {$message}\n";
        }
    }
}
