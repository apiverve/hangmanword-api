...
class TestHangmanwordAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = HangmanwordAPIClient(self.api_key)

    @patch('apiverve_hangmanwordgenerator.apiClient.requests.get')
