...
```bash
curl -X GET "https://api.apiverve.com/v1/hangmanword?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/hangmanword](https://docs.apiverve.com/ref/hangmanword)

---

## Use Cases

Common use cases for the Hangman Word Generator API:
