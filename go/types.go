// Package hangmanword provides a Go client for the Hangman Word Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/hangmanword?utm_source=go&utm_medium=readme
package hangmanword
...
// Request contains the parameters for the Hangman Word Generator API.
//
// Parameters:
//   - category: string - Word category
//   - difficulty: string - Difficulty level
//   - count: integer - Number of words [min: 1, max: 10]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"count": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(10)},
	}
...
// ResponseData contains the data returned by the Hangman Word Generator API.
...
type WordsItem struct {
	...
	UniqueLetters int `json:"uniqueLetters"`
	Difficulty string `json:"difficulty"`
	Category string `json:"category"`
