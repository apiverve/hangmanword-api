...
const (
	baseURL        = "https://api.apiverve.com/v1/hangmanword"
	defaultTimeout = 30 * time.Second
)

// Client is the Hangman Word Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Hangman Word Generator API client.
...
// Execute makes a request to the Hangman Word Generator API with typed parameters.
//
