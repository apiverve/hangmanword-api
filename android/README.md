# Hangman Word Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:hangmanword-api:1.1.14'
}
```
...
```java
import com.apiverve.hangmanword.HangmanWordGeneratorAPIClient;
import com.apiverve.hangmanword.APIResponse;
import com.apiverve.hangmanword.APIException;

// Initialize the client
HangmanWordGeneratorAPIClient client = new HangmanWordGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("category", "random");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/hangmanword](https://docs.apiverve.com/ref/hangmanword)
...
- **Documentation:** [https://docs.apiverve.com/ref/hangmanword](https://docs.apiverve.com/ref/hangmanword)
- **Issues:** [GitHub Issues](https://github.com/apiverve/hangmanword-api/issues)
